	ownerName = "Mushine OT"
	ownerEmail = "suporte@mushineglobal.com"
	url = "http://mushineglobal.com"
	location = "Brazil"

	motd = "Seja bem vindo ao Mushine ATS!"
	serverName = "Mushine ATS"
	loginMessage = "Mushine ATS"
	...
	fragsToRedSkull = 100
	fragsSecondToRedSkull = 400
	fragsThirdToRedSkull = 1000
	redSkullLength = 1 * 24 * 60 * 60

	fragsToBlackSkull = 150
	fragsSecondToBlackSkull = 600
	fragsThirdToBlackSkull = 1500
	...
	deathLostPercent = 1
	stairhopDelay = 1.0 * 1000
	pushCreatureDelay = 250
